	...
	return (
		<div className="iconVisibility-vptxma wrapper-NhbLHG">
			<div className="content-1gYQeQ">
				<Link href={`/channels/${guildID}/${channel.id}`} role="link" className="mainContent-20q_Hp" data-list-item-id="channels___750760218505248807" aria-label="📸pic-n-memes (text channel)">
					<a>
