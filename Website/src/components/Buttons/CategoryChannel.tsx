...
export default function categoryChannel({ name }: Props) {
	return (
		<li className="channelItem onselect">
			<button className="catToggle channelItem" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
				<div className="icon">
				...
				<div className="options">
					<div className="iconItem-1EjiK0 iconBase-2G48Fc" aria-label="Create Invite" tabIndex={0} role="button">
