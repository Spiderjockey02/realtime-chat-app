				...
				<div className="modal-content">
					<div className="modal-split">
						<div className="modal-header">
							<h5 className="modal-title" id="exampleModalLongTitle" style={{ color:'black' }}>Create a server</h5>
							<button type="button" className="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						</div>
						<p className="text-center">Your server is where you and your friends hang out.Make yours and start talking.</p>
						<div className="modal-body">
							<img alt="" src="/img/icons/createServer.svg" />
							<button type="button" name="button" id="sdhjlslhdjfsfdhds">Create your own</button>
							<h6 style={{ color:'black' }}>Already have an invite?</h6>
							<button type="button" name="button" className="btn btn-secondary" style={{ width:'100%' }} id="sdfdsfdsfdsfdsfdfs">Join a server</button>
						</div>
					</div>
					<div className="modal-split">
						<div className="modal-header">
						...
						<div className="modal-body">
							<form>
								...
								<a type="button" id="sdfusdbfndskdsghjds">Back</a>
					...
					<div className="modal-split">
						<div className="modal-header">
							<h5 className="modal-title" id="exampleModalLongTitle" style={{ color:'black' }}>Customize your server</h5>
							<button type="button" className="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						</div>
						...
						<div className="modal-body">
							<form action="/api/guilds" method="post">
								<div style={{ margin: 'auto', width: '40%' }}>
									...
									<input className="file-input" type="file" name="server_icon" accept=".jpg,.jpeg,.png,.gif" aria-label="Upload a Server Icon"></input>
								</div>
								<div className="form-group">
									<label>Server name</label>
									<input type="text" className="form-control" name="server_name" />
								...
								<a type="button" id="sdfusdbfndskdsghjd8">Back</a>
